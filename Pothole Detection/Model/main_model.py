...
def evaluate_model(X_train, Y_train, X_test, Y_test):
    ...
    Conv1D(filters=16, kernel_size=3, activation='relu', kernel_regularizer=tf.keras.regularizers.l1(0.001)),
    MaxPooling1D(pool_size=2, strides=2),
    Conv1D(filters=32, kernel_size=5, activation='relu', kernel_regularizer=tf.keras.regularizers.l1(0.001)),
    MaxPooling1D(pool_size=2, strides=2),
    tf.keras.layers.Dropout(0.4),
    tf.keras.layers.Bidirectional(tf.keras.layers.LSTM(16, activation='relu', kernel_regularizer=tf.keras.regularizers.l1(0.001))),
