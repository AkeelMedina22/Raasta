...
def evaluate_model(X_train, Y_train, X_test, Y_test):
    ...
    RF = RandomForestClassifier(n_estimators=10000, max_depth=100, max_features=5).fit(X_train, Y_train)
