...
def evaluate_model(X_train, Y_train, X_test, Y_test):
    ...
    predict = np.where(m_predict > 0.5, 1, 0)
    ...
    print(f1_score(Y_test, m_predict, zero_division=1))
    print(recall_score(Y_test, m_predict, zero_division=1))
    print(precision_score(Y_test, m_predict, zero_division=1))
